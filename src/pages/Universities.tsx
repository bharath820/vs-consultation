...
const universities = {
  uk: [
    ...
    { id: 11, name: "University of East Anglia", country: "United Kingdom", location: "Norwich", ranking: "Top 30 UK University" },
    { id: 12, name: "Kingston University London", country: "United Kingdom", location: "London", ranking: "Modern University" },
    { id: 13, name: "Ravensbourne University London", country: "United Kingdom", location: "London", ranking: "Specialist Creative University" },
    { id: 14, name: "Edinburgh Napier University", country: "United Kingdom", location: "Edinburgh", ranking: "Top Scottish Modern University" },
    { id: 15, name: "Glasgow Caledonian University", country: "United Kingdom", location: "Glasgow", ranking: "Top Scottish Modern University" },
    { id: 16, name: "London South Bank University", country: "United Kingdom", location: "London", ranking: "Modern University" },
  ],
  canada: [
...
const Universities = () => {
  ...
  const universityList = universities[countryKey as keyof typeof universities] || universities.uk;
