    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-full font-medium flex items-center justify-center gap-2 transition">
            <Phone className="w-5 h-5" /> Book Free Consultation
          </button>
          <button className="bg-blue-900 hover:bg-blue-950 text-white px-6 py-3 rounded-full font-medium flex items-center justify-center gap-2 transition">
